...
class GoodsCategoryBrand(models.Model):
    category=models.ForeignKey(GoodsCategory,null=True,balnk=True,verbose_name='商品类目',on_delete=models.CASCADE)
...
class Goods(models.Model):
    ...
    goods_front_image=models.ImageField(upload_to='',null=True,balnk=True,verbose_name='封面图')
